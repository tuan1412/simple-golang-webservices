...
func SetupRoutes(apiBasePath string) {
	...
	http.Handle(fmt.Sprintf("%s/%s", apiBasePath, receiptPath), middleware.Cors(receiptHandler))
	http.Handle(fmt.Sprintf("%s/%s/", apiBasePath, receiptPath), middleware.Cors(downloadHandler))
}
